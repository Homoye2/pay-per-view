import { Box, Typography,   InputAdornment, Modal, Button ,Dialog, DialogTitle,Grid , DialogContent, DialogActions,TextField  } from '@mui/material';
  ...
  return (
    <Box sx={{ padding: 2 }}>
          ...
          {selectedVideo && (
            <>
              ...
              <Typography variant="body2" gutterBottom >
                Prix : {selectedVideo.prix} fcfa   - categorie : {selectedVideo.type}
              </Typography>
              <Typography variant="body2" gutterBottom >
      ...
      <Box sx={{ flex: { xs: '12', sm: '6' ,lg:'2' } , marginTop: 10,}}>
        ...
        >
          <Link href={paths.interfaceFilm} style={{ textDecoration: 'none' }}> {'Films'} </Link>
        </Typography>
