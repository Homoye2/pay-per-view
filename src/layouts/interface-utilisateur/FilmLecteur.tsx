    ...
    return (
        <Box p={2}>
            <Box display="flex" gap="16px" flexWrap="wrap" mb={2} sx={{ marginTop:10 }}>
                <Button variant="contained" color="primary" onClick={() => navigate(`${paths.interfaceFilm}`) } style={{ borderRadius: '22px' }}>
                    Retour
                </Button>
            </Box>
            <Divider />
